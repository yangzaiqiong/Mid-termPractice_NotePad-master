...
public final class NotePad {
    ...
    public static final class Notes implements BaseColumns {
        ...
        /**
         * Column name for the current background
         * <P>Type: INTEGER </P>
         */
        public static final String COLUMN_NAME_BACKGROUND = "background";

        /**
         * Column name for the current text color
         * <P>Type: INTEGER </P>
         */
        public static final String COLUMN_NAME_TEXT_COLOR = "textcolor";

        /**
         * Column name for the current text size
         * <P>Type: INTEGER </P>
         */
        public static final String COLUMN_NAME_TEXT_SIZE = "textsize";

        /**
         * Column name for the set alarm date
         * <P>Type: INTEGER </P>
         */
        public static final String COLUMN_NAME_ALARM_DATE = "alarmdata";
    }
}
